   ...
   this.init = () => {
      ...
      toDoList.innerHTML = `<div class="todolist__wrapper" />
                               <div class="todolist__header">
                                   ...
                                   <input type="text" placeholder ="Get Task..." class="todolist__input">
                               </div>
   ...
   this.deleteEvent = () => {
      ...
      deleteButtons.forEach((deleteButton) => {
         deleteButton.addEventListener('click', (e) => {
            this.deleteToDo(e.target.dataset.delete);
         })
      })
   }


   this.deleteToDo = (deletedId) => {
   ...
   this.show = () => {
      ...
      toDoListArr.forEach(({ taskName, id, isDone }) => {
         li += `<li class="todolist_item">
                   <label class="${isDone ? "todolist__task done" : "todolist__task "}" ><input id="${id}" type="checkbox" class="checkbox" ${isDone ? "checked" : ""}>
                   ${taskName}</label>
